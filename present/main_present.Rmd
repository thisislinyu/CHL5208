...
### Feature Selection in High Demensional Dataset is Necessay

- Remove noisy features

- <span style="color: red;">Extention to </span>

### Existing Algorithms Do not Consider Interaction effects
- random

### Propsed HDSI Algorithm
- incorporated interaction terms

- tested with continuous and binary outcome

---
class: center, middle 
> ## Objective: Extend HDSI to time-to-event data


---
# Main ideas of feature selection

- What we want to achieve in FS: Find **important** features 

- How do we measure the importance of features?
