...
<span style="color:black;font-weight:90;font-size:1.25rem"> 
**HDSI/RHDSI algorithm**: High dimensional selection with interactions algorithm, which accounts for  
1. interaction terms; 2. statistical significance of features
...
- apply the algorithm in simulation study
